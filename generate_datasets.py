...
logger.info(
    "This script assumes you have locally processed the data with bin2ml. Every options "
...
if CISCO_DATASET_2_DATA_RAW is not None:
    ...
    logger.warning("The value of CISCO_DATASET_2_DATA_RAW is None. Skipping...")
...
if BINKIT_NOINLINE_DATA_RAW is not None:
    ...
    logger.warning("The value of BINKIT_NOINLINE_DATA_RAW is None. Skipping...")
...
if BINKIT_NORMAL_DATA_RAW is not None:
    ...
    logger.warning("The value of BINKIT_NORMAL_DATA_RAW is None. Skipping...")
...
if BINARYCORP_DATA_RAW is not None:
    ...
    logger.warning("The value of BINARYCORP_DATA_RAW is None. Skipping...")
...
if BINARYCORP_WITH_DUPS_RAW is not None:
    ...
    logger.warning("The value of BINARYCORP_WITH_DUPS_RAW is None. Skipping...")
